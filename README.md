...
The code is here in case someone wants to build it for a different platform, do note, there is no endianness detection, this tool relies on the hardware being little-endian to work correctly.
...
In fact, I've never been able to win at it on 3DS, it just doesn't feel right mashing the buttons like that...

But you're still required to beat this minigame if you want collection item #9.
